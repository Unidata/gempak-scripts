...
GDFILE   = $MODEL/nam/2015061312_nam212.gem
GDOUTF   = $MODEL/nam/2015061312_nam212.gem
GDATTIM  = F033
GLEVEL   = 3000
GVCORD   = pres/zagl
GAREA    = grid
...
gdplot3_gf << eof
	...
	GLEVEL	 = 3000
	GVCORD	 = zagl	
	GDPFUN	 = cape(pres@3000%zagl,3000,tmpc@3000%zagl,dwpc@3000%zagl)
	TYPE	 = F
	CONTUR	 = 0
	CINT	 = 10;25;50;75;100;150;250;300;500;1000
	...
	WIND	 = 
	REFVEC	 =  
	TITLE	 = 31/-3/0-3 KM CAPE (J/kg) COD NEXLAB   WEATHER.COD.EDU
	TEXT	 = 1/1/hw
	CLEAR	 = n
	GAREA	 = ${Domain}
	PROJ	 = ${Projection}
