...
SKIP	 = 0
SCALE	 = 0
GDPFUN	 = sm5s(mul(ens_prob(gt(CAPE,1000)),100))!ens_savg(HGHT@500%PRES)!ENS_VAVG(kntv(wnd@500%PRES))
TYPE	 = F!C!B
CONTUR	 = 0 
CINT	 = 60
LINE	 = 32/1/2
...
WIND	 = bk32/.6//112
REFVEC	 =  
TITLE	 = 31/-3/AVG. 500mb HEIGHT (m); PROB. CAPE > 1000 (J/kg) - COD NEXLAB   WEATHER.COD.EDU
TEXT	 = 1/1/hw
CLEAR	 = y
GAREA	 = $Domain
PROJ	 = $Projection
