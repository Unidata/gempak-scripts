...
SKIP	 = 0
SCALE	 = 6!0!9!9
GDPFUN	 = sm9s(pvor(THTA,WND))!WND@300%PRES!sm9s(adv(pvor(THTA,WND),WND@300%PRES))!sm9s(adv(pvor(THTA,WND),WND@300%PRES))
TYPE	 = F          !S				!C					!C
CONTUR	 = 0 
CINT	 = !60 ! .1;.2;.3;.4;.5;.6;.7;.8;.9 ! -.9-.8;-.7;-.6;-.5;-.4;-.3;-.2;-.1
LINE	 = !32/1/1 ! 1/1/2 ! 15/2/2
...
WIND	 = ak6/.6//111/.5
REFVEC	 =  
TITLE	 = 31/-3/400-250mb POTENTIAL VORT. (PVU) / PV ADV. / 300mb STREAMLINES - WEATHER.COD.EDU
TEXT	 = 1/1/hw
CLEAR	 = y
GAREA	 = $Domain
PROJ	 = $Projection
MAP	     = 32//1
STREAM   = $stream/1.4/0/1000/0
LATLON	 =  
IJSKIP   = $IJSkip
