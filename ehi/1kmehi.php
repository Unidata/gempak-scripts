...
SKIP	 = 0
SCALE	 = 0
GDPFUN	 = QUO(MUL(HLCY@1000:0%hght,CAPE),160000)
TYPE	 = F
CONTUR	 =  
CINT	 =  
LINE	 = 32/10/1
...
HILO     =32;32/1#2;1#2/1-100;1-100/12/30;0 
HLSYM    = .8;.8/2/1;1/1;1/HW
#HILO	 = 4;2/H;L//2/1;1/YES
#HLSYM	 = 3//1/6/hw
CLRBAR   = 31/h/lc/.5;.002/.95;.012/2/|.65/1
WIND	 = bk32/.7//112
REFVEC	 = 
TITLE	 = 31/-3/0-1km ENERGY HELICITY INDEX - COD NEXLAB   WEATHER.COD.EDU
TEXT	 = 1/1/hw
CLEAR	 = y
GAREA	 = $Domain
PROJ	 = $Projection
