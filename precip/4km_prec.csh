...
if ($Sector == "US") then
	set mapfil = "base"
	set map = "5//1"
    set cint = "2\!300/5100/5700\!60"
else if ($Sector == "NA") then
    set mapfil = "base"
	set map = "5//1"
    set cint = "4\!300/5100/5700\!60"
else
...
if (($ModName == NAM) || ($ModName == NAM4KM)) then
    set PMSL = "EMSL"
	set QPF = "P${QPFhr}M"
...
#	GDPFUN	 = quo(P${QPFhr}M,25.4)!${PMSL}!SUB(HGHT@500%PRES,HGHT@1000%PRES)!SUB(HGHT@500%PRES,HGHT@1000%PRES)
	GDPFUN	 = quo(${QPF},25.4)!${PMSL}!SUB(HGHT@500%PRES,HGHT@1000%PRES)!SUB(HGHT@500%PRES,HGHT@1000%PRES)
	TYPE	 = F!C!C!C
	CONTUR	 =  
