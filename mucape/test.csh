...
r
	...
	GDPFUN	 = CAPE ! vmsk(vsub(kntv(shr@0:6000%HGHT),kntv(wnd@10%hght)),sge(CAPE,250))
	TYPE	 = F ! B
	CONTUR	 = 0
	...
	WIND	 = bk32/.7//112
	REFVEC	 =  
	TITLE	 = 31/-3/SBCAPE / 0-6km SHEAR (kts) - COD NEXLAB   WEATHER.COD.EDU
	TEXT	 = 1/1/hw
	CLEAR	 = n
	GAREA	 = ${Domain}
	PROJ	 = ${Projection}
