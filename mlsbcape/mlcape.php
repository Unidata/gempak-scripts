...
TITLE    = 0
r
GDPFUN	 = mask(abs(CINS@90:0%PDLY),sge(CAPE@90:0%PDLY,10))!CAPE@90:0%PDLY!kntv(wnd @10 %HGHT)
TYPE	 = F!C!B
CONTUR	 = 0
...
WIND	 = bk32/.6//112
REFVEC	 =  
TITLE	 = 31/-3/MLCAPE (J/kg) / MLCIN (J/kg) / 10m WIND (kts) - COD NEXLAB   WEATHER.COD.EDU
TEXT	 = 1/1/hw
CLEAR	 = n
DEVICE	 = GIF|$ImageFileName|$Size
STNPLT   = $stnplt
