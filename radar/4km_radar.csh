...
echo ${ModRunTime}Z  ${ModName} ${FHour} hour - Valid ${vtime} "            ." > ${ModName}${ModRunTime}${Level}${Product}${FHour}.txt
...
gdplot3_gf << eof
    ...
    BOXLIN   = 32
	REGION   = view 
	TXTFIL 	 = ${ModName}${ModRunTime}${Level}${Product}${FHour}.txt
	TXTLOC	 = .8;1
...
rm ${ModName}${ModRunTime}${Level}${Product}${FHour}.txt
